...
exports.getDashboardStats = async (req, res) => {
    try {
        const data = await authService.getDashboardStats(req, res);
...
exports.uploadProfilePic = async (req, res) => {
    try {
        const data = await authService.uploadProfilePic(req, res);
...
exports.updateUser = async (req, res) => {
    try {
        const data = await authService.updateUser(req, res);
